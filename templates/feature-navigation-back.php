...
//TODO Future release add hover effect on button.
...
echo '<div class="epkb-navigation-back  ' . //$kb_config['back_navigation_hover'] .  // what is the hover for? not in configuration specs
          '" ' . $button_style1 . '>';

if ( $kb_config['back_navigation_mode'] == 'navigate_kb_main_page' ) {
	echo '<div class="epkb-navigation-button">';
    ...
    echo '<div class="epkb-navigation-button"' . $button_style2 . ' onclick="history.go(-1);" >' . esc_html($kb_config['back_navigation_text']) . '</div>';
}
