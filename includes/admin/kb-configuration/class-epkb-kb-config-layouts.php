...
class EPKB_KB_Config_Layouts {
	...
	const KB_DEFAULT_LAYOUT_STYLE = 'Basic';
	const KB_DEFAULT_COLORS_STYLE = 'black-white1';
	...
	public static function get_kb_main_page_layout_name( $kb_config ) {
		$layout = empty($kb_config['kb_main_page_layout']) || ! in_array($kb_config['kb_main_page_layout'], array_keys(self::get_main_page_layout_names()) )
	...
	public static function get_article_page_layout_names() {
		$core_layouts = array (
			self::KB_ARTICLE_PAGE_NO_LAYOUT => __( 'Article', 'echo-knowledge-base' )
		);
	 ...
	 * // TODO arrays with translations (callrs need to use array_keys() as array values are not constant)
	 */
	...
	public static function get_colors_names() {
		$core_colors = array (
				self::KB_DEFAULT_COLORS_STYLE => self::KB_DEFAULT_COLORS_STYLE,
	...
	public static function register_kb_config_hooks() {
		...
		add_filter( 'epkb_max_layout_level', array( 'EPKB_KB_Config_Layouts', 'get_max_layout_level'), 2, 10 );
	...
	public static function get_max_layout_level( $layout ) {
		return $layout == EPKB_KB_Config_Layout_Basic::LAYOUT_NAME ? EPKB_KB_Config_Layout_Basic::CATEGORY_LEVELS : EPKB_KB_Config_Layout_Tabs::CATEGORY_LEVELS;
	}
