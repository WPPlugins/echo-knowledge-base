...
class EPKB_KB_Config_Layout_Tabs {
            ...
            'inputs' => array(
	            ...
	            '1' => $form->multiple_number_inputs(
		            array(
			            ...
			            'main_label_class'  => '',
			            'input_class'       => '',
			            'label'             => 'Section Header Padding( px )'
		            ),
    ...
    public static function get_kb_config_colors( $kb_page_layout, $kb_config ) {
        ...
        $form->option_group( $feature_specs, array(
            ...
            'inputs'            => array(
                ...
                '2' => $form->text( $feature_specs['tab_nav_border_color'] + array(
                ...
                '4' => $form->text( $feature_specs['section_divider_color'] + array(
                ...
                '6' => $form->text( $feature_specs['section_head_description_font_color'] + array(
    ...
    public static function get_kb_config_text( $kb_page_layout, $kb_config ) {
        ...
        $form->option_group( $feature_specs, array(
            'info'              => array('category_empty_msg', 'non_existent_category_name', 'default_category_name', 'choose_main_topic'),
            ...
            'inputs' => array(
                ...
                '3' => $form->text( $feature_specs['default_category_name'] +
                    array( 'value' => $kb_config['default_category_name'], 'current' => $kb_config['default_category_name'],
                            ...
                            'label_class'       => 'config-col-3',
                             'input_class'       => 'config-col-9'       ) ),
                '4' => $form->text( $feature_specs['choose_main_topic'] + array(
    ...
    private static function colors_set_1( $args = array() ) {
        ...
        return array(
            ...
            //Category Tabs
            'tab_nav_active_font_color'             =>  $args['base_color'],
            'tab_nav_active_background_color'       =>  $args['bg_color_light'],
            'tab_nav_font_color'                    =>  $args['text_color_light'],
            'tab_nav_background_color'              =>  $args['bg_color_light'],
            'tab_nav_border_color'                  =>  $args['border_color_dark'],
    ...
    private static function colors_set_2( $args = array() ) {
        ...
        return array(
            ...
            //Category Tabs
            'tab_nav_active_font_color'             =>  $args['text_color_dark'],
            'tab_nav_active_background_color'       =>  $args['bg_color_light'],
            'tab_nav_font_color'                    =>  $args['text_color_light'],
            'tab_nav_background_color'              =>  $args['bg_color_light'],
            'tab_nav_border_color'                  =>  $args['border_color_dark'],
    ...
    private static function colors_set_3( $args = array() ) {
        ...
        return array(
            ...
            'tab_nav_font_color'                    =>  $args['text_color_light'],
            'tab_nav_background_color'              =>  $args['bg_color_light'],
            'tab_nav_border_color'                  =>  $args['base_color'],
    ...
    private static function colors_set_4( $args = array() ) {
        ...
        return array(
            ...
            'tab_nav_active_background_color'       =>  $args['base_color'],
            'tab_nav_font_color'                    =>  $args['bg_color_light'],
            'tab_nav_background_color'              =>  $args['bg_color_dark'],
            'tab_nav_border_color'                  =>  $args['base_color'],
    ...
    private static function get_style_2_set() {
        return array(
            ...
            'expand_articles_icon'          =>  'ep_icon_plus_box',
            'nof_columns'                   =>  'three-col',
            'section_body_height'           =>  350,
            'section_box_height_mode'       =>  'section_no_height',
