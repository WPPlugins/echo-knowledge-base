...
class EPKB_Layout_Basic extends EPKB_Layout {
	...
	*/
	public function generate_kb_main_page() {
		...
		<div id="epkb-main-page-container" class="epkb-basic-template">
	...
	private function display_main_page_content() {
		...
		$class1 = $this->get_css_class( ' ::nof_columns, ::section_font_size, epkb-categories-list' ); ?>
	...
	private function display_box_sub_sub_categories( $box_sub_sub_category_list ) {
		$body_style1 = $this->get_inline_style( 'margin-left:: article_list_margin' );  	?>
		<ul class="epkb-sub-sub-category" <?php echo $body_style1; ?>> <?php
	...
	private function display_articles_list( $level, $category_id, $sub_category_exists=false ) {
		...
		if ( $level == 1 ) {
			...
			$sub_category_styles .= 'margin-left:: sidebar_article_list_margin,';
		} else if ( $level == 2 ) {
